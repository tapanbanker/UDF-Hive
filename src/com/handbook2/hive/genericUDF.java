...
@Description(
        name = "containsString",
        value = "_FUNC_(List<T>,T) - Checks if a string is present in a list of strings ",
        extended = "Example:\n" +
                "  > SELECT containsString(List('ab','cd'),'ab') FROM authors a;\n" +
                "   TRUE "
)

class genericUDF extends GenericUDF {
